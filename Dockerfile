...
RUN R -q -e "options(warn = 2); \
    ...
    remotes::install_version('extrafontdb', version = '1.0', upgrade = FALSE); \
...
RUN R -q -e "options(warn = 2); \
    ...
    remotes::install_version('Rttf2pt1', version = '1.3.12', upgrade = FALSE); \
...
RUN R -q -e "options(warn = 2); \
    ...
    remotes::install_version('extrafont', version = '0.19', upgrade = FALSE); \
...
RUN R -q -e "options(warn = 2); \
    ...
    remotes::install_version('textshaping', version = '1.0.1', upgrade = FALSE); \
...
RUN R -q -e "options(warn = 2); \
    ...
    remotes::install_version('ragg', version = '1.4.0', upgrade = FALSE); \
...
RUN R -q -e "options(warn = 2); \
    ...
    remotes::install_version('ggrepel', version = '0.9.6', upgrade = FALSE); \
