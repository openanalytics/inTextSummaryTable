...
RUN R -q -e "remotes::install_version('magrittr', version = '2.0.3', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('MASS', version = '7.3-58.2', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('Rcpp', version = '1.0.10', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('xfun', version = '0.37', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('processx', version = '3.8.0', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('triebeard', version = '0.3.0', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('mgcv', version = '1.8-41', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('vctrs', version = '0.5.2', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('crosstalk', version = '1.2.0', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('crul', version = '1.3', upgrade = FALSE)"
RUN R -q -e "remotes::install_version('fontawesome', version = '0.5.0', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('hms', version = '1.1.2', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('officer', version = '0.6.0', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('stringr', version = '1.5.0', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('dplyr', version = '1.1.0', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('forcats', version = '1.0.0', upgrade = FALSE)"
RUN R -q -e "remotes::install_version('ggplot2', version = '3.4.1', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('cowplot', version = '1.1.1', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('gfonts', version = '0.2.0', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('ggrepel', version = '0.9.3', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('waldo', version = '0.4.0', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('DT', version = '0.27', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('gdtools', version = '0.3.1', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('haven', version = '2.5.1', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('flextable', version = '0.8.6', upgrade = FALSE)"
