...
RUN R -q -e "install.packages('remotes')" && \
    ...
    R -q -e "remotes::install_version('cpp11', version = '0.4.6', upgrade = FALSE)"
RUN R -q -e "remotes::install_version('crayon', version = '1.5.2', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('curl', version = '5.0.2', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('MASS', version = '7.3-60', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('rlang', version = '1.1.1', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('xml2', version = '1.3.5', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('fontquiver', version = '0.2.1', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('Matrix', version = '1.6-1', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('rex', version = '1.2.1', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('tinytex', version = '0.46', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('htmltools', version = '0.5.6', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('mgcv', version = '1.9-0', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('fontawesome', version = '0.5.2', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('tidyselect', version = '1.2.0', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('officer', version = '0.6.2', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('ggplot2', version = '3.4.3', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('waldo', version = '0.5.1', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('gdtools', version = '0.3.3', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('flextable', version = '0.9.3', upgrade = FALSE)"
