...
RUN R -q -e "install.packages('remotes')" && \
    ...
    R -q -e "remotes::install_version('brio', version = '1.1.4', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('cpp11', version = '0.4.7', upgrade = FALSE)"
RUN R -q -e "remotes::install_version('crayon', version = '1.5.2', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('curl', version = '5.2.1', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('data.table', version = '1.15.2', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('digest', version = '0.6.34', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('fontLiberation', version = '0.1.0', upgrade = FALSE)"
...
RUN R -q -e "remotes::install_version('MASS', version = '7.3-60.0.1', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('Rcpp', version = '1.0.12', upgrade = FALSE)"
RUN R -q -e "remotes::install_version('rlang', version = '1.1.3', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('stringi', version = '1.8.3', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('xfun', version = '0.42', upgrade = FALSE)"
RUN R -q -e "remotes::install_version('xtable', version = '1.8-4', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('highr', version = '0.10', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('processx', version = '3.8.3', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('rex', version = '1.2.1', upgrade = FALSE)"
RUN R -q -e "remotes::install_version('systemfonts', version = '1.0.6', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('callr', version = '3.7.5', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('knitr', version = '1.45', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('memoise', version = '2.0.1', upgrade = FALSE)"
RUN R -q -e "remotes::install_version('mgcv', version = '1.9-1', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('hms', version = '1.1.3', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('httpuv', version = '1.6.14', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('pkgbuild', version = '1.4.3', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('purrr', version = '1.0.2', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('ragg', version = '1.2.7', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('tidyselect', version = '1.2.0', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('officer', version = '0.6.5', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('ggplot2', version = '3.5.0', upgrade = FALSE)" && \
...
RUN R -q -e "remotes::install_version('readr', version = '2.1.5', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('waldo', version = '0.5.2', upgrade = FALSE)" && \
    R -q -e "remotes::install_version('DT', version = '0.32', upgrade = FALSE)" && \
    ...
    R -q -e "remotes::install_version('flextable', version = '0.9.5', upgrade = FALSE)"
