...
For 'flag' variable (e.g ending with 'FL' in _ADaM_/_SDTM_ format),
...
```{r count-flag-variables}
	...
	getSummaryStatisticsTable(
		data = dataSLExample,
		var = c("SAFFL", "FASFL", "PKFL"),
		varFlag = c("SAFFL", "FASFL", "PKFL")
	)
...
```{r countTable-LB-customDenominator}
	...
	dataTotal <- subset(dataAll$ADSL, TRT01P != "Screen Failure")
