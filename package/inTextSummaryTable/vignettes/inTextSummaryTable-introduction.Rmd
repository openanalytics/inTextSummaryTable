...
If no variables are specified in \code{var}, counts across row/column variable
are displayed.
...
### Layout for variables with summary statistics

The variables to summarize (`var`) are included by default in rows.
In case multiple variables are to be summarized, the different variables
can be included in different columns by including the specific label: 'variable'
in `colVar`.
