...
For this vignette, ADaM datasets from the _CDISC_ study,
 included in the `clinUtils` package are used.
...
If the data is loaded into R with the `read_haven` of the `haven` package,
 or the `loadDataADaMSDTM` function of the `clinUtils` package, the label
