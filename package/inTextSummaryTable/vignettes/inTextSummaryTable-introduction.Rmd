...
The number of decimals for the number of subjects and percentages
are specified below:

```{r nDecimalsSAP-phase23, echo = FALSE, fig.cap = "Standard Layout for Frequency Tabulations of Categorical Variables (_GLPGS_Mock Standards_v1.0_FINAL.docx_ document, from 5/02/2020)"}
...
The number of decimals for individual values is based on the Tables below, 
unless the number of digits in the database is lower. In this case,  
the resolution of the specified values is used.

```{r nDecimalsSAP-phase23, echo = FALSE, fig.cap = "Standard Layout for Descriptive Statistics of Continuous Variables (_GLPGS_Mock Standards_v1.0_FINAL.docx_ document, from 5/02/2020)"}
