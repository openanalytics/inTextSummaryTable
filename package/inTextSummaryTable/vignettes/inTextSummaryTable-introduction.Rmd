...
```{r rowVarTotalPerc}
	...
	pander(aggregate(USUBJID ~ PARAM + TRTA, data = dataLBPostBaseline, n_distinct))
...
```{r dataTotalRow}
	...
	pander(ddply(dataTEAEInterestWC[, c("USUBJID", "TRTA", "AESOC", "AEDECOD", "AESEV", "AESEVN")], "USUBJID"), split.tables = Inf)
