...
customColorPalette <- c("blue", "green", "red")
subjectProfileSummaryPlot(
    data = dataPlot,
    xVar = "AVISIT",
    colorVar = "TRTP",
...
package. This is because when loading the package, the default global options
...
# custom color palette by setting a simple vector of colors
customColorPalette <- c("blue", "green")
options(inTextSummaryTable.colors.plot = customColorPalette)
...
# custom linetype palette
customLinetypePalette <- c("dotted", "longdash")
