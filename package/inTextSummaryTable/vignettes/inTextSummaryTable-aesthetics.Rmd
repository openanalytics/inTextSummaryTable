...
Morevoer, **palettes are set through global options**.
...
* **`inTextSummaryTable.colors.table.report`**
...
The options with the wording _table.report_ or _table.presentation_ define the
color scheme for tables in report or presentation style, respectively.
...
# options for color scheme in reports
options("inTextSummaryTable.colors.table.report")
